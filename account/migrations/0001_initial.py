    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh1234567890', length=10, max_length=20, prefix='217', unique=True)),
                ('account_status', models.CharField(choices=[('active', 'Active'), ('pending', 'Pending')], default='pending', max_length=100)),
